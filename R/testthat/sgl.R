...
test_that("solution reduces to sgl when using constant weights, with uneven groups, with intercept and standardisation", { # a different sgs version, which uses 1/n-1 standardisation, as this is what seagull uses
  n = 50
  p = 100
  groups = c(rep(1:5, each=3),
           rep(6:11, each=4),
